...
@Module({
  imports: [ ConfigModule.forRoot({ isGlobal: true }), TypeOrmModule.forRoot(typeOrmConfig as TypeOrmModuleOptions), TokenModule, UserModule, PaymentModule, ApplicationModule, WebsocketModule ],
